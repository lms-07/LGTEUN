...
checkpoint_list = [0,  # 0
                   f'data/PSData3/model_out/INNT/{datas}/train_out_1000e_ori/model_iter_253000.pth',
                   f'data/PSData3/model_out/INNT/{datas}/train_out_1000e_ori/model_iter_227500.pth']
